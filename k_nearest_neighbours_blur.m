function k_nearest_neighbours_blur(k, num_of_train_data, num_of_test_data, show_log)
  ...
  % Load package for image blurring.
  pkg load image
  ...
  for i = 1:num_of_test_data
    ...
    for j = 1:num_of_train_data
      ...
      % Apply the filter on the train image.
      train_image = imfilter(train_image,h_gaussian,'replicate');
