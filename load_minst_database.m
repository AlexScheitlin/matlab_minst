...
# [images, labels] = load_minst_database('data/t10k-images-idx3-ubyte', 'data/t10k-labels-idx1-ubyte');
...
# Loads the MINST database of handwritten digits available on:
# http://yann.lecun.com/exdb/mnist/
function [images, labels] = load_minst_database(path_to_images, path_to_labels)
